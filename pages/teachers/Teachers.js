...
import ModalComponent from "../reusableComponents/Modal";
import SelectComponent from "../reusableComponents/Select";
      ...
      <div className="row">
        ...
        <div className="col-sm-12 d-flex justify-content-end">
          <button className="addStudentButton">
            <Link className="nav-link active" href="/teachers/addTeacher">
              <span>
